...
public class PeopleRankWithDecisionEngineBackup1 implements RoutingDecisionEngine, NodeRanking {
    ...
    public PeopleRankWithDecisionEngineBackup1(Settings s) {
...
//        }
    ...
    public PeopleRankWithDecisionEngineBackup1(PeopleRankWithDecisionEngineBackup1 proto) {
        this.peopleRank = 0.0;
    ...
    public void doExchangeForNewConnection(Connection con, DTNHost peer) {
        ...
        PeopleRankWithDecisionEngineBackup1 prde = ambilDecisionRouterDari(peer);
        ...
        if (!this.teman.containsKey(peer)) {
            ...
            if (totalPertemuan >= threshold) {
                ...
                prde.teman.put(myHost, infoKita);
            }            
    ...
    public boolean shouldSendMessageToHost(Message m, DTNHost otherHost, DTNHost thisHost) {
        PeopleRankWithDecisionEngineBackup1 prde = ambilDecisionRouterDari(otherHost);
    ...
    public PeopleRankWithDecisionEngineBackup1 ambilDecisionRouterDari(DTNHost h) {
        MessageRouter routerLain = h.getRouter();
        assert routerLain instanceof DecisionEngineRouter : "Bukan Decision Engine Router";
        return (PeopleRankWithDecisionEngineBackup1) ((DecisionEngineRouter) routerLain).getDecisionEngine();
    }
    ...
    public RoutingDecisionEngine replicate() {
        return new PeopleRankWithDecisionEngineBackup1(this);
    }
}
