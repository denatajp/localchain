...
public abstract class MessageRouter {
     ...
     * Setting value for FIFO queue mode
     */
    public static final int Q_MODE_TTL = 3;
            ...
            case Q_MODE_TTL:
                Collections.sort(list,
                    ...
                    public int compare(Object o1, Object o2) {
                        ...
                        double sekarang = SimClock.getTime();
                        
                        // baca sisa TTL m1
                        double diffM1 = m1.getTtl() - (sekarang - m1.getCreationTime());
                        
                        // baca sisa TTL m2
                        double diffM2 = m2.getTtl() - (sekarang - m2.getCreationTime());
                        
                        // hitung selisih untuk perbandingan
                        diff = diffM1 - diffM2;
                        
                        // jika m1 dan m2 ttl nya 
                        if (diff == 0) {
                            return 0;
                        }
                        return (diff < 0 ? 1 : -1);
